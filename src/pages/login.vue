        ...
        <div class="login-form">
          <div class="card-block">
            ...
            <div class="input-group m-b-1">
              ...
              <input type="text" class="form-control" placeholder="手机/邮箱" v-model="form.username">
            </div>
            ...
            <div class="row">
              <el-row>
                <el-col :span="12">
                  <el-button type="primary" class="btn btn-primary p-x-2 myButton" @click="login">登录</el-button>
                </el-col>
                <el-col :span="12">
      ...
      <el-col :span="24" :xs="24" :sm="8" :md="8" :lg="8">
        <div class="login-register">
          <div class="card-block">
            <h2>注册</h2>
            <p>平台暂时只支持使用公司邮箱注册.</p>
            <el-button type="info" class="btn btn-primary active m-t-1 myButton-1"> 立即注册</el-button>
          </div>
        </div>
        </el-col>
        </el-row>
...
<style>
  html {
    background-color: rgba(197, 186, 186, 0.5);
  }
  .login {
    margin-top: 160px;
    width: 100%;
  ...
  .myButton {
    background: linear-gradient(to right top, #7d98e4 30%, #078aca 100%);
  }

  .myButton:hover {
    background: linear-gradient(to right top, #078aca 30%, #7d98e4 100%);
  }

  .myButton-1 {
    background: linear-gradient(to right top, #eaa0ad 30%, #e8506a 100%);
  }

  .myButton-1:hover {
    background: linear-gradient(to right top, #e8506a 30%, #eaa0ad 100%);
  }
